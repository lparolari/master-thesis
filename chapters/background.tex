...
discuss most relevant projects, highlighting their pro and cons.
...
jointly conditioning on both left and right context in all layer.
BERT's key technical innovation is applying the bidirectional training
of Transformer, a popular attention model, to language modelling. This
is in contrast to previous efforts which looked at a text sequence
