...
\end{equation}
 ...
 \todo{DA SPECIFICARE ALTROVE: Please note that for readability, we
 use $\bm{P}$ as $\bm{\hat{P}}$ outside of this section. Both two are
 matrix of predictions and have same dimension.}
