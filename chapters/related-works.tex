...
Also S. A. Javed \etal{} in \todo{Learning Unsupervised Visual
Grounding Through Semantic Self-Supervision} make use of an attention
map, but in this case they optimize the model for concept learning
proxy task, which require the model to jointly decode the common
concept in a batch of examles composed by image and captions. S. Datta
\textit{et al.} in \todo{CITE: align2g} developed three-step model in
which, 
