...
During our work, we trained the model on the training set, while we
...
\begin{figure}
  ...
  \caption[Number of examples per label over top-100 most popular
    labels on Flicker30k]{ Distribution of examples ($y$ axis, log
...
$XX\%$ absolute accuracy. Indeed, ReferIt contains complex sentences
